  ...
  const [campaigns, setCampaigns] = useState([
    {
      ...
      breakdown: [
        { id: 101, team: "RRPP Noche", promoter: "Juan Pérez", code: "RRPP-JUAN", uses: 12, status: 'active' },
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800">
      ...
      <header className="bg-white border-b border-slate-200 px-8 py-5 flex justify-between items-center sticky top-0 z-10">
        <div>
          ...
          <p className="text-sm text-slate-500">Gestiona campañas automáticas, códigos de RRPP y descuentos.</p>
        </div>
        <button 
      ...
      <main className="max-w-7xl mx-auto p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <KpiCard title="Campañas Activas" value={activeCount} icon={Ticket} color="text-indigo-600" bg="bg-indigo-50" />
          <KpiCard title="Códigos Canjeados" value="207" icon={Users} color="text-emerald-600" bg="bg-emerald-50" sub="Esta semana" />
          <KpiCard title="Total Descontado" value="2,220€" icon={Euro} color="text-amber-600" bg="bg-amber-50" sub="Impacto Global" />
                ...
                {showFilters && (
                    <div className="p-4 bg-slate-50 rounded-lg border border-slate-200 animate-in slide-in-from-top-2 fade-in">
                        <div className="flex items-end gap-6">
                            ...
                            <div className="w-48">
                                <label className="text-xs font-bold text-slate-500 uppercase mb-1.5 block">Tipo de Campaña</label>
                                <select 
                                ...
                                >
                                    ...
                                    <option value="batch">Batch / RRPP (Múltiple)</option>
                                    <option value="single">Código Único</option>
                    ...
                    <td className="px-6 py-4">
                        <div className="flex flex-col gap-1">
                            <span className="text-xs font-medium text-slate-600 flex items-center gap-1.5">
                                {camp.trigger === 'automatic' ? '⚡ Automática' : '🔑 Código'}
                            </span>
                                    ...
                                    <table className="w-full max-w-3xl text-sm border border-slate-200 rounded-lg overflow-hidden bg-white">
                                        <thead className="bg-slate-100 text-slate-600 font-semibold text-xs">
                                            <tr>
                                                ...
                                                <th className="px-4 py-2 text-left">Código Asignado</th>
                                        ...
                                        <tbody className="divide-y divide-slate-100">
                                            {camp.breakdown && camp.breakdown.length > 0 ? (
                                                ...
                                                <tr>
                                                    <td colSpan="6" className="px-4 py-3 text-center text-slate-400 italic">No hay datos de uso disponibles aún.</td>
                                                </tr>
                                            )}
                                        </tbody>
                                    </table>
                ...
                <tr>
                    <td colSpan="7" className="px-6 py-12 text-center text-slate-400">
                        <div className="flex flex-col items-center gap-2">
                            ...
                            <p>No se encontraron campañas con los filtros actuales.</p>
                            <button 
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="bg-slate-50 px-8 py-6 border-b border-slate-100 flex justify-between items-start">
              <div>
                <h2 className="text-xl font-bold text-slate-900">
                    {formData.name ? 'Editar Campaña' : 'Nueva Campaña'}
                </h2>
              ...
              {step === 1 && (
                <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
                  ...
                  <div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
                    <label className="text-sm font-bold text-slate-700 mb-3 block">¿Cómo se activa?</label>
                    <div className="grid grid-cols-2 gap-4">
                         <SelectableCard 
                            ...
                            desc="El usuario debe introducir un cupón."
                          />
                          <SelectableCard 
                  ...
                  {formData.triggerType === 'code' && (
                      <div className="space-y-4 animate-in fade-in slide-in-from-top-2">
                        <label className="text-sm font-bold text-slate-700">Configuración de Códigos</label>
                        ...
                        {formData.mode === 'single' ? (
                            ...
                            <div className="space-y-4 border-t border-slate-200 pt-4">
                                ...
                                <div>
                                    <label className="text-sm font-bold text-slate-700 mb-2 block">Equipos de Promoción (Selección Múltiple)</label>
                                ...
                                <div className="bg-purple-50 p-3 rounded-lg border border-purple-100">
                                    ...
                                    />
                                    <p className="text-[10px] text-purple-600 mt-1">Añade usuarios específicos fuera de los equipos seleccionados.</p>
                                </div>

                                <div className="grid grid-cols-2 gap-4">
                                    <InputGroup label="Prefijo Código" placeholder="Ej: RRPP-" value={formData.batchPrefix} onChange={(e) => setFormData({...formData, batchPrefix: e.target.value})} />
            ...
            <div className="bg-white border-t border-slate-100 p-6 flex justify-between items-center">
              ...
              >
                {step < 3 ? (<>Siguiente <ChevronRight className="w-4 h-4" /></>) : 'Guardar Campaña'}
              </button>
            </div>
          </div>
        </div>
